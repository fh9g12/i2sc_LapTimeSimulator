...
%
% [alpha,Cl,Cd] = open.genAeroPolar(section)
% [alpha,Cl,Cd] = open.genAeroPolar(section,options)
% [alpha,Cl,Cd] = open.genAeroPolar('0012')
%
%   section   NACA 4-digit code, as a 4-character string, e.g. '0012'
%
% Runs TWO separate open.naca4Aero sweeps -- 0:step:range and
...
%            open.naca4Aero unchanged -- see there for defaults/meaning
    ...
    [ClPos,CdPos] = open.naca4Aero(section,alphaPos,naca4AeroArgs{:}) ;
    [ClNeg,CdNeg] = open.naca4Aero(section,alphaNeg,naca4AeroArgs{:}) ;
